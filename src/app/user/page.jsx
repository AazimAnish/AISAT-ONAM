...
const Profile = () => {
    return (
        <BackgroundGradientAnimation
            gradientBackgroundStart={"#FFEA00"}
            gradientBackgroundEnd={"#FFFFFF"}
            firstColor={"#FBEC5D"}
            pointerColor={"#FFFAA0"}
        >
            <div className="h-screen w-screen flex justify-center items-center overflow-hidden p-4">
                ...
                <Card className="bg-white/25 backdrop-blur-md border border-white/20 shadow-xl rounded-xl overflow-hidden z-40">
